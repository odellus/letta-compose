...
from crow.helpers.crypto_utils import CryptoUtils
...
def upgrade() -> None:
    ...
    encryption_key = os.environ.get("CROW_ENCRYPTION_KEY")
    if not encryption_key:
        print("WARNING: CROW_ENCRYPTION_KEY not set. Skipping data encryption migration.")
