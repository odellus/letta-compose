...
from crow.constants import BASE_MEMORY_TOOLS, BASE_TOOLS
...
def upgrade() -> None:
    ...
    letta_core_value = ToolType.CROW_CORE.value
    letta_memory_core_value = ToolType.CROW_MEMORY_CORE.value
