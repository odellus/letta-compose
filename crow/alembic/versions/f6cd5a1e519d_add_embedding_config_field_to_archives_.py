...
def upgrade() -> None:
    ...
    op.add_column("archives", sa.Column("embedding_config", crow.orm.custom_columns.EmbeddingConfigColumn(), nullable=True))
    ...
    default_config = EmbeddingConfig.default_config(model_name="crow")
