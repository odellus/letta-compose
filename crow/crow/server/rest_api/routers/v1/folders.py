...
from crow.errors import CrowInvalidArgumentError, CrowUnsupportedFileUploadError
from crow.helpers.pinecone_utils import (
    delete_file_records_from_pinecone_index,
    delete_source_records_from_pinecone_index,
    should_use_pinecone,
)
from crow.helpers.tpuf_client import should_use_tpuf
...
from crow.schemas.enums import DuplicateFileHandling, FileProcessingStatus
from crow.schemas.file import FileMetadata, FileMetadataBase
from crow.schemas.folder import BaseFolder, Folder
from crow.schemas.passage import Passage
from crow.schemas.source import BaseSource, Source, SourceCreate, SourceUpdate
from crow.schemas.source_metadata import OrganizationSourcesStats
...
from crow.services.file_processor.embedder.openai_embedder import OpenAIEmbedder
from crow.services.file_processor.embedder.pinecone_embedder import PineconeEmbedder
from crow.services.file_processor.file_processor import FileProcessor
from crow.services.file_processor.file_types import get_allowed_media_types, get_extension_to_mime_type_map, register_mime_types
from crow.services.file_processor.parser.markitdown_parser import MarkitdownFileParser
from crow.services.file_processor.parser.mistral_parser import MistralFileParser
from crow.settings import settings
from crow.utils import safe_create_file_processing_task, safe_create_task, sanitize_filename
from crow.validators import FileId, FolderId
...
async def upload_file_to_folder(
    ...
    if media_type not in allowed_media_types:
        raise CrowUnsupportedFileUploadError(
            message=(
...
async def load_file_to_source_cloud(
    ...
    if should_use_tpuf():
        from crow.services.file_processor.embedder.turbopuffer_embedder import TurbopufferEmbedder
