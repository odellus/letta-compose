...
from crow.schemas.group import Group, GroupBase, GroupCreate, GroupUpdate, ManagerType
from crow.schemas.crow_message import CrowMessageUnion, CrowMessageUpdateUnion
from crow.schemas.crow_request import CrowRequest, CrowStreamingRequest
from crow.schemas.crow_response import CrowResponse
from crow.schemas.message import BaseMessage
...
from crow.validators import GroupId, MessageId
...
@router.patch("/{group_id}/messages/{message_id}", response_model=CrowMessageUnion, operation_id="modify_group_message")
async def modify_group_message(
    ...
    actor = await server.user_manager.get_actor_or_default_async(actor_id=headers.actor_id)
    return await server.message_manager.update_message_by_crow_message(message_id=message_id, crow_message_update=request, actor=actor)
