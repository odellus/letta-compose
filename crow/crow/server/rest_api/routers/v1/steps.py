...
from crow.schemas.step import Step, StepBase
...
from crow.services.step_manager import FeedbackType
from crow.settings import settings
from crow.validators import StepId
...
@router.get("/{step_id}/messages", response_model=List[CrowMessageUnion], operation_id="list_messages_for_step")
async def list_messages_for_step(
    ...
    return Message.to_crow_messages_from_list(messages)
