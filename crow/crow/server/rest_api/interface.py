...
from crow.constants import DEFAULT_MESSAGE_TOOL, DEFAULT_MESSAGE_TOOL_KWARG
from crow.helpers.datetime_helpers import is_utc_datetime
...
from crow.schemas.crow_message_content import ReasoningContent, RedactedReasoningContent, TextContent
from crow.schemas.message import Message
from crow.schemas.openai.chat_completion_response import ChatCompletionChunkResponse
from crow.server.rest_api.json_parser import OptimisticJSONParser
from crow.streaming_interface import AgentChunkStreamingInterface
from crow.streaming_utils import FunctionArgumentsStreamHandler, JSONInnerThoughtsExtractor
from crow.utils import parse_json
...
class StreamingServerInterface(AgentChunkStreamingInterface):
    ...
    async def _create_generator(self) -> AsyncGenerator[Union[CrowMessage, LegacyCrowMessage, MessageStreamStatus], None]:
    ...
    def _push_to_buffer(
        ...
        assert isinstance(item, CrowMessage) or isinstance(item, LegacyCrowMessage) or isinstance(item, MessageStreamStatus), (
    ...
    def _process_chunk_to_crow_style(
        self,
                    ...
                    # If we have main_json, we should output a ToolCallMessage
                        ...
                        # output the arguments chunk as a ToolCallMessage
                            ...
                            if self.use_assistant_message and (
                                ...
                                from crow.streaming_utils import sanitize_streamed_message_content
    ...
    def _process_chunk_to_openai_style(self, chunk: ChatCompletionChunkResponse) -> Optional[dict]:
        """Chunks should look like OpenAI, but be remapped from crow-style concepts.
    ...
    def process_chunk(
        ...
        if self.streaming_chat_completion_mode:
            ...
            processed_chunk = self._process_chunk_to_crow_style(
                chunk=chunk,
