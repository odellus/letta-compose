...
from crow.log_context import clear_log_context, update_log_context
from crow.schemas.enums import PrimitiveType
from crow.validators import PRIMITIVE_ID_PATTERNS
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    - Crow primitive IDs: agent_id, tool_id, block_id, etc. from URL paths
    ...
    async def dispatch(self, request: Request, call_next: Callable):
        ...
        try:
            ...
            custom_context = {}
            if hasattr(exc, "__crow_context__"):
                custom_context = exc.__crow_context__
