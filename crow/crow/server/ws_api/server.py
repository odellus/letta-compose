...
from crow.server.constants import WS_DEFAULT_PORT
from crow.server.server import SyncServer
from crow.server.ws_api.interface import SyncWebSocketInterface
...
class WebSocketServer:
    ...
    async def start_server(self):
        ...
        # and https://github.com/crow-ai/crow/issues/471
