...
import crow.server.ws_api.protocol as protocol
from crow.server.constants import WS_CLIENT_TIMEOUT, WS_DEFAULT_PORT
from crow.server.utils import condition_to_stop_receiving, print_server_response
...
async def basic_cli_client():
    """Basic example of a Crow CLI client that connects to a Crow server.py process via WebSockets
