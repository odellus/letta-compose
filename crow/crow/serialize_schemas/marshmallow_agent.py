...
import crow
from crow.orm import Agent, Message as MessageModel
from crow.schemas.agent import AgentState as PydanticAgentState
from crow.schemas.user import User
from crow.serialize_schemas.marshmallow_agent_environment_variable import SerializedAgentEnvironmentVariableSchema
from crow.serialize_schemas.marshmallow_base import BaseSchema
from crow.serialize_schemas.marshmallow_block import SerializedBlockSchema
from crow.serialize_schemas.marshmallow_custom_fields import EmbeddingConfigField, LLMConfigField, ToolRulesField
from crow.serialize_schemas.marshmallow_message import SerializedMessageSchema
from crow.serialize_schemas.marshmallow_tag import SerializedAgentTagSchema
...
class MarshmallowAgentSchema(BaseSchema):
    ...
    def sanitize_ids(self, data: Dict, **kwargs):
        ...
        data[self.FIELD_VERSION] = crow.__version__
    ...
    def check_version(self, data, **kwargs):
        ...
        if version != crow.__version__:
            print(f"Version mismatch: expected {crow.__version__}, got {version}")
