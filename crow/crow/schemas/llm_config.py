...
from crow.schemas.enums import AgentType, ProviderCategory
from crow.schemas.response_format import ResponseFormatUnion

if TYPE_CHECKING:
    from crow.schemas.model import ModelSettings
...
class LLMConfig(BaseModel):
    ...
    .. deprecated::
        ...
        Use the schemas in crow.schemas.model (ModelSettings, OpenAIModelSettings, etc.) instead.
    ...
    def validate_codex_reasoning_effort(cls, values):
        ...
        """
        from crow.llm_api.openai_client import does_not_support_minimal_reasoning
    ...
    def default_config(cls, model_name: str):
        ...
        Args:
            model_name (str): The name of the model (gpt-4, gpt-4o-mini, crow).
        """
        if model_name == "gpt-4":
            return cls(
                model="gpt-4",
    ...
    def _to_model_settings(self) -> "ModelSettings":
        ...
        """
        from crow.schemas.model import (
    ...
    def apply_reasoning_setting_to_config(cls, config: "LLMConfig", reasoning: bool, agent_type: Optional["AgentType"] = None):
        ...
        For AgentType.crow_v1_agent, we enforce stricter semantics:
        ...
        """
        from crow.llm_api.openai_client import does_not_support_minimal_reasoning, supports_none_reasoning_effort

        # V1 agent policy: do not allow simulated reasoning for non-native models
        if agent_type is not None and agent_type == AgentType.crow_v1_agent:
