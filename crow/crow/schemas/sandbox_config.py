...
from crow.constants import CROW_TOOL_EXECUTION_DIR, MODAL_DEFAULT_TIMEOUT
from crow.schemas.agent import AgentState
from crow.schemas.enums import PrimitiveType, SandboxType
from crow.schemas.crow_base import CrowBase, OrmMetadataBase
    ...
    def set_default_sandbox_dir(cls, data):
        ...
        if data.get("sandbox_dir") is None:
            if tool_settings.tool_exec_dir:
                ...
                data["sandbox_dir"] = CROW_TOOL_EXECUTION_DIR
