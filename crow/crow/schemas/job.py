...
if TYPE_CHECKING:
    from crow.schemas.crow_request import CrowRequest
...
from crow.schemas.enums import JobStatus, JobType
...
class CrowRequestConfig(BaseModel):
    ...
    @classmethod
    def from_crow_request(cls, request: "CrowRequest") -> "CrowRequestConfig":
        """Create a CrowRequestConfig from a CrowRequest."""
        return cls(
