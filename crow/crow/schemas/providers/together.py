...
from crow.constants import MIN_CONTEXT_WINDOW
from crow.errors import ErrorCode, LLMAuthenticationError
...
class TogetherProvider(OpenAIProvider):
    ...
    async def list_embedding_models_async(self) -> list[EmbeddingConfig]:
        ...
        logger.warning(
            "Crow does not currently support listing embedding models for Together. Please "
