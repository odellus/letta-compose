...
from crow.schemas.enums import PrimitiveType, RunStatus
...
class Run(RunBase):
    ...
    request_config: Optional[CrowRequestConfig] = Field(None, description="The request configuration for the run.")
