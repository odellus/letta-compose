...
class CrowImage(ImageSource):
    type: Literal[ImageSourceType.crow] = Field(default=ImageSourceType.crow, description="The source type for the image.")
...
ImageSourceUnion = Annotated[Union[UrlImage, Base64Image, CrowImage], Field(discriminator="type")]
...
CrowUserMessageContentUnion = Annotated[
    Union[TextContent, ImageContent],
    Field(discriminator="type"),
]


def create_crow_user_message_content_union_schema():
    return {
        "oneOf": [
...
def get_crow_user_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/CrowUserMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
CrowAssistantMessageContentUnion = Annotated[
    Union[TextContent],
    Field(discriminator="type"),
]


def create_crow_assistant_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
        ],
...
def get_crow_assistant_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/CrowAssistantMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
CrowMessageContentUnion = Annotated[
    Union[
        TextContent,
        ImageContent,
        ToolCallContent,
...
def create_crow_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
            {"$ref": "#/components/schemas/ImageContent"},
...
def get_crow_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/CrowMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
