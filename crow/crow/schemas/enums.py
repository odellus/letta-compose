...
class PrimitiveType(str, Enum):
    """
    Enum for all primitive resource types in Crow.
...
class ToolType(str, Enum):
    CUSTOM = "custom"
    CROW_CORE = "crow_core"
    CROW_MEMORY_CORE = "crow_memory_core"
    CROW_MULTI_AGENT_CORE = "crow_multi_agent_core"
    CROW_SLEEPTIME_CORE = "crow_sleeptime_core"
    CROW_VOICE_SLEEPTIME_CORE = "crow_voice_sleeptime_core"
    CROW_BUILTIN = "crow_builtin"
    CROW_FILES_CORE = "crow_files_core"
