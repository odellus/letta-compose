...
from crow.schemas.crow_message_content import (
    CrowAssistantMessageContentUnion,
    CrowUserMessageContentUnion,
    get_crow_assistant_message_content_union_str_json_schema,
    get_crow_user_message_content_union_str_json_schema,
)

# ---------------------------
# Crow API Messaging Schemas
# ---------------------------
...
CrowMessageReturnUnion = Annotated[Union[ApprovalReturn, ToolReturn], Field(discriminator="type")]
...
class CrowMessage(BaseModel):
    """
    Base class for simplified Crow message response type. This is intended to be used for developers
...
class SystemMessage(CrowMessage):
    """
...
class UserMessage(CrowMessage):
    ...
    Args:
        ...
        date (datetime): The date the message was created in ISO format
        name (Optional[str]): The name of the sender of the message
        content (Union[str, List[CrowUserMessageContentUnion]]): The message content sent by the user (can be a string or an array of multi-modal content parts)
    """

    message_type: Literal[MessageType.user_message] = Field(default=MessageType.user_message, description="The type of the message.")
    content: Union[str, List[CrowUserMessageContentUnion]] = Field(
        ...,
        description="The message content sent by the user (can be a string or an array of multi-modal content parts)",
        json_schema_extra=get_crow_user_message_content_union_str_json_schema(),
    )


class ReasoningMessage(CrowMessage):
    """
...
class HiddenReasoningMessage(CrowMessage):
    """
...
class ToolCallMessage(CrowMessage):
    """
...
class ToolReturnMessage(CrowMessage):
    """
    A message representing the return value of a tool call (generated by Crow executing the requested tool).
...
class ApprovalRequestMessage(CrowMessage):
    """
...
class ApprovalResponseMessage(CrowMessage):
    """
...
class AssistantMessage(CrowMessage):
    """
    ...
    Args:
        ...
        date (datetime): The date the message was created in ISO format
        name (Optional[str]): The name of the sender of the message
        content (Union[str, List[CrowAssistantMessageContentUnion]]): The message content sent by the agent (can be a string or an array of content parts)
    """
    ...
    content: Union[str, List[CrowAssistantMessageContentUnion]] = Field(
        ...,
        description="The message content sent by the agent (can be a string or an array of content parts)",
        json_schema_extra=get_crow_assistant_message_content_union_str_json_schema(),
    )


class CrowPing(CrowMessage):
    """
...
class CrowErrorMessage(BaseModel):
    """
...
class SummaryMessage(CrowMessage):
    """
...
class EventMessage(CrowMessage):
    """
...
def create_crow_message_union_schema():
    return {
        "oneOf": [
...
def create_crow_error_message_schema():
    return {
        "properties": {
            "message_type": {
                "type": "string",
...
CrowMessageUpdateUnion = Annotated[
...
CrowMessageSearchResult = Annotated[
    Union[
...
class LegacyFunctionCallMessage(CrowMessage):
    function_call: str


class LegacyFunctionReturn(CrowMessage):
    """
    A message representing the return value of a function call (generated by Crow executing the requested function).
...
class LegacyInternalMonologue(CrowMessage):
    """
...
LegacyCrowMessage = Union[LegacyInternalMonologue, AssistantMessage, LegacyFunctionCallMessage, LegacyFunctionReturn]
