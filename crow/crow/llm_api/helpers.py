...
from crow.constants import OPENAI_CONTEXT_WINDOW_ERROR_SUBSTRING
from crow.helpers.json_helpers import json_dumps
from crow.log import get_logger
from crow.schemas.message import Message
from crow.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice
...
from crow.settings import summarizer_settings
...
def convert_response_format_to_responses_api(
    ...
    """
    Convert Crow's ResponseFormatUnion to OpenAI Responses API text.format structure.
    ...
    Args:
        response_format: Crow ResponseFormatUnion object
