...
from crow.errors import CrowConfigurationError, RateLimitExceededError
from crow.llm_api.helpers import unpack_all_inner_thoughts_from_kwargs
from crow.log import get_logger

logger = get_logger(__name__)
from crow.llm_api.openai import (
    build_openai_chat_completions_request,
    openai_chat_completions_process_stream,
    openai_chat_completions_request,
    prepare_openai_payload,
)
from crow.local_llm.chat_completion_proxy import get_chat_completion
...
from crow.settings import ModelSettings
...
def create(
    ...
    if llm_config.model_endpoint_type == "openai":
        if model_settings.openai_api_key is None and llm_config.model_endpoint == "https://api.openai.com/v1":
            ...
            raise CrowConfigurationError(message="OpenAI key is missing from crow config file", missing_fields=["openai_api_key"])
