...
from crow.constants import NON_USER_MSG_PREFIX
...
from crow.local_llm.json_parser import clean_json_string_extra_backslash
...
from crow.schemas.openai.chat_completion_request import Tool, Tool as OpenAITool
from crow.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, FunctionCall, Message, ToolCall, UsageStatistics
from crow.settings import model_settings, settings
...
class GoogleVertexClient(LLMClientBase):
    ...
    def add_dummy_model_messages(messages: List[dict]) -> List[dict]:
        ...
        In Crow, the 'model' will often call a function (e.g. send_message) that itself yields to the user,
    ...
    def convert_tools_to_google_ai_format(self, tools: List[Tool], llm_config: LLMConfig) -> List[dict]:
        ...
        for func in function_list:
            ...
            if llm_config.put_inner_thoughts_in_kwargs:
                from crow.local_llm.constants import INNER_THOUGHTS_KWARG_DESCRIPTION, INNER_THOUGHTS_KWARG_VERTEX
    ...
    def build_request_data(
        ...
        contents = self.add_dummy_model_messages(
            PydanticMessage.to_google_dicts_from_list(
                ...
                put_inner_thoughts_in_kwargs=False if agent_type == AgentType.crow_v1_agent else True,
                native_content=True if agent_type == AgentType.crow_v1_agent else False,
            ),
        )
                ...
                for response_message in parts:
                    ...
                    if response_message.function_call:
                        ...
                        if llm_config.put_inner_thoughts_in_kwargs:
                            ...
                            from crow.local_llm.constants import INNER_THOUGHTS_KWARG_VERTEX
    ...
    async def count_tokens(self, messages: List[dict] = None, model: str = None, tools: List[OpenAITool] = None) -> int:
        ...
        """
        from crow.llm_api.google_constants import GOOGLE_MODEL_FOR_API_KEY_CHECK
