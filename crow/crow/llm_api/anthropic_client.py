...
from crow.constants import FUNC_FAILED_HEARTBEAT_MESSAGE, REQ_HEARTBEAT_MESSAGE, REQUEST_HEARTBEAT_PARAM
...
from crow.llm_api.helpers import add_inner_thoughts_to_functions, unpack_all_inner_thoughts_from_kwargs
from crow.llm_api.llm_client_base import LLMClientBase
from crow.local_llm.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_DESCRIPTION
...
from crow.schemas.openai.chat_completion_request import Tool as OpenAITool
...
class AnthropicClient(LLMClientBase):
    ...
    def build_request_data(
        ...
        prefix_fill = True if agent_type != AgentType.crow_v1_agent else False
        is_v1 = agent_type == AgentType.crow_v1_agent
        ...
        if not tools:
            ...
            tool_choice = None
        elif self.is_reasoning_model(llm_config) and llm_config.enable_reasoner or agent_type == AgentType.crow_v1_agent:
