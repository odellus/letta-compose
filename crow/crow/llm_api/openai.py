...
from crow.constants import CROW_MODEL_ENDPOINT
from crow.errors import ErrorCode, LLMAuthenticationError, LLMError
from crow.helpers.datetime_helpers import timestamp_to_datetime
from crow.llm_api.helpers import add_inner_thoughts_to_functions, convert_to_structured_output, make_post_request
from crow.llm_api.openai_client import (
...
from crow.schemas.message import Message as PydanticMessage, MessageRole as _MessageRole
...
from crow.schemas.openai.embedding_response import EmbeddingResponse
from crow.settings import model_settings
from crow.streaming_interface import AgentChunkStreamingInterface, AgentRefreshStreamingInterface
from crow.utils import get_tool_call_id, smart_urljoin
...
def openai_get_model_list(url: str, api_key: Optional[str] = None, fix_url: bool = False, extra_params: Optional[dict] = None) -> dict:
    ...
    # In Crow config the address for vLLM is w/o a /v1 suffix for simplicity
...
def openai_chat_completions_process_stream(
    ...
    To "stream" the response in Crow, we want to call a streaming-compatible interface function
