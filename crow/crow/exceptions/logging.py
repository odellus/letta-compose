...
def add_exception_context(exception: Exception, **context) -> Exception:
    ...
    This attaches a __crow_context__ attribute to the exception with structured data.
    ...
    """
    if not hasattr(exception, "__crow_context__"):
        exception.__crow_context__ = {}
    exception.__crow_context__.update(context)
    return exception
