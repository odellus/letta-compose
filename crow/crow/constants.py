...
CROW_DIR = os.path.join(os.path.expanduser("~"), ".crow")
CROW_TOOL_EXECUTION_DIR = os.path.join(CROW_DIR, "tool_execution_dir")

CROW_MODEL_ENDPOINT = "https://inference.crow.com/v1/"
...
CROW_CORE_TOOL_MODULE_NAME = "crow.functions.function_sets.base"
CROW_MULTI_AGENT_TOOL_MODULE_NAME = "crow.functions.function_sets.multi_agent"
CROW_VOICE_TOOL_MODULE_NAME = "crow.functions.function_sets.voice"
CROW_BUILTIN_TOOL_MODULE_NAME = "crow.functions.function_sets.builtin"
CROW_FILES_TOOL_MODULE_NAME = "crow.functions.function_sets.files"
...
DEFAULT_CROW_MODEL = "gpt-4"  # TODO: fixme
...
DEPRECATED_CROW_TOOLS = ["archival_memory_insert", "archival_memory_search"]
# Base memory tools CAN be edited, and are added by default by the server
BASE_MEMORY_TOOLS = ["core_memory_append", "core_memory_replace", "memory", "memory_apply_patch", "memory_read"]
...
# Set of all built-in Crow tools
CROW_TOOL_SET = set(
    BASE_TOOLS
    + BASE_MEMORY_TOOLS
    + MULTI_AGENT_TOOLS
...
# The error message that Crow will receive
...
REDIS_DEFAULT_CACHE_PREFIX = "crow_cache"
...
# builtin web search
WEB_SEARCH_MODEL_ENV_VAR_NAME = "CROW_BUILTIN_WEBSEARCH_OPENAI_MODEL_NAME"
