...
from crow.helpers.datetime_helpers import ns_to_ms
from crow.log import get_logger
from crow.otel.context import add_ctx_attribute, get_ctx_attributes
...
def get_crow_meter() -> Meter:
    """Returns the global crow meter if metrics are initialized."""
