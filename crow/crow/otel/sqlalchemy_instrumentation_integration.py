...
This module provides easy integration with the existing Crow application,
...
from crow.otel.sqlalchemy_instrumentation import (
...
def setup_crow_db_instrumentation(
    enable_joined_monitoring: bool = True,
    sql_truncate_length: int = 1000,
    additional_config: Optional[Dict[str, Any]] = None,
) -> None:
    """
    Set up SQLAlchemy instrumentation for Crow application.
...
def teardown_crow_db_instrumentation() -> None:
    """Tear down SQLAlchemy instrumentation for Crow application."""
...
def configure_crow_db_instrumentation(**kwargs) -> None:
    """
    Configure SQLAlchemy instrumentation for Crow application.
...
def setup_fastapi_db_instrumentation(app, **config_kwargs):
    ...
    async def startup_db_instrumentation():
        setup_crow_db_instrumentation(**config_kwargs)
