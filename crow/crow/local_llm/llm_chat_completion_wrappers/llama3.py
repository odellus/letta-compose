...
from crow.local_llm.json_parser import clean_json
from crow.local_llm.llm_chat_completion_wrappers.wrapper_base import LLMChatCompletionWrapper
...
class LLaMA3InnerMonologueWrapper(LLMChatCompletionWrapper):
    ...
    def _clean_function_args(self, function_name, function_args):
        """Some basic Crow-specific cleaning of function args"""
