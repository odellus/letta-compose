...
from crow.constants import IN_CONTEXT_MEMORY_KEYWORD
from crow.helpers import ToolRulesSolver
from crow.helpers.datetime_helpers import format_datetime, get_local_time_fast
...
class PromptGenerator:
    ...
    def get_system_message_from_compiled_memory(
        ...
        if IN_CONTEXT_MEMORY_KEYWORD in variables:
            ...
            # Add kv_cache_friendly note if enabled
            if kv_cache_friendly:
                kv_cache_note = (
                ...
                full_memory_string += kv_cache_note
