...
from crow.schemas.openai.chat_completion_response import ChatCompletionResponse, ToolCall
...
class CrowLLMAdapter(ABC):
    ...
    def __init__(self, llm_client: LLMClientBase, llm_config: LLMConfig) -> None:
        ...
        self.usage: CrowUsageStatistics = CrowUsageStatistics()
    ...
    async def invoke_llm(
        ...
        Yields:
            CrowMessage: Chunks of data for streaming adapters, or None for blocking adapters
        """
