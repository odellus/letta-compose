...
from crow.orm.provider import Provider as ProviderModel
from crow.orm.provider_model import ProviderModel as ProviderModelORM
from crow.otel.tracing import trace_method
from crow.schemas.embedding_config import EmbeddingConfig
from crow.schemas.enums import PrimitiveType, ProviderCategory, ProviderType
from crow.schemas.llm_config import LLMConfig
from crow.schemas.provider_model import ProviderModel as PydanticProviderModel
from crow.schemas.providers import Provider as PydanticProvider, ProviderCheck, ProviderCreate, ProviderUpdate
...
class ProviderManager:
    ...
    async def create_provider_async(self, request: ProviderCreate, actor: PydanticUser, is_byok: bool = True) -> PydanticProvider:
        ...
        async with db_registry.async_session() as session:
            from crow.schemas.enums import ProviderCategory
    ...
    async def _sync_default_models_for_provider(self, provider: PydanticProvider, actor: PydanticUser) -> None:
        ...
        try:
            ...
            from crow.schemas.providers.anthropic import AnthropicProvider
            from crow.schemas.providers.azure import AzureProvider
            from crow.schemas.providers.bedrock import BedrockProvider
            from crow.schemas.providers.google_gemini import GoogleAIProvider
            from crow.schemas.providers.groq import GroqProvider
            from crow.schemas.providers.ollama import OllamaProvider
            from crow.schemas.providers.openai import OpenAIProvider
