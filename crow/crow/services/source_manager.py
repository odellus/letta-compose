...
from crow.schemas.source import Source as PydanticSource, SourceUpdate
from crow.schemas.user import User as PydanticUser
from crow.server.db import db_registry
from crow.utils import enforce_types, printd
    ...
    async def _upsert_sources_individually(self, source_data_list: List[PydanticSource], actor: PydanticUser) -> List[PydanticSource]:
        ...
        for source in source_data_list:
            ...
            if existing_source:
                ...
                from crow.schemas.source import SourceUpdate
