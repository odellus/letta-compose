...
from crow.helpers.singleton import singleton
...
from crow.orm.step_metrics import StepMetrics as StepMetricsModel
from crow.otel.tracing import get_trace_id, trace_method
from crow.schemas.enums import PrimitiveType, StepStatus
...
from crow.schemas.step_metrics import StepMetrics as PydanticStepMetrics
from crow.schemas.user import User as PydanticUser
from crow.server.db import db_registry
from crow.services.webhook_service import WebhookService
...
class StepManager:
    ...
    def log_step(
        ...
        project_id: Optional[str] = None,
        stop_reason: Optional[CrowStopReason] = None,
