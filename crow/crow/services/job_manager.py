...
from crow.orm.job import Job as JobModel
from crow.orm.message import Message as MessageModel
from crow.orm.sqlalchemy_base import AccessType
from crow.orm.step import Step, Step as StepModel
from crow.otel.tracing import log_event, trace_method
from crow.schemas.enums import JobStatus, JobType, MessageRole, PrimitiveType
from crow.schemas.job import BatchJob as PydanticBatchJob, Job as PydanticJob, JobUpdate, CrowRequestConfig
...
from crow.schemas.run import Run as PydanticRun
...
class JobManager:
    ...
    async def get_run_messages(
        ...
        Returns:
            List of CrowMessages associated with the job
        ...
        messages = PydanticMessage.to_crow_messages_from_list(
            messages=messages,
    ...
    async def _get_run_request_config(self, run_id: str) -> CrowRequestConfig:
        """
        ...
        async with db_registry.async_session() as session:
            ...
            request_config = job.request_config or CrowRequestConfig()
