...
from crow.constants import MAX_FILENAME_LENGTH
from crow.helpers.pinecone_utils import list_pinecone_index_for_files, should_use_pinecone
from crow.log import get_logger
from crow.orm.errors import NoResultFound
from crow.orm.file import FileContent as FileContentModel, FileMetadata as FileMetadataModel
from crow.orm.sqlalchemy_base import AccessType
from crow.otel.tracing import trace_method
from crow.schemas.enums import FileProcessingStatus, PrimitiveType
...
from crow.schemas.source_metadata import FileStats, OrganizationSourcesStats, SourceStats
...
class FileManager:
    ...
    async def get_organization_sources_metadata(
        ...
        async with db_registry.async_session() as session:
            ...
            from crow.orm.source import Source as SourceModel
    ...
    async def get_files_for_agents_async(
        ...
        async with db_registry.async_session() as session:
            ...
            from crow.orm.file_agent import FileAgent as FileAgentModel
