...
from crow.orm.sandbox_config import SandboxConfig as SandboxConfigModel, SandboxEnvironmentVariable as SandboxEnvVarModel
from crow.otel.tracing import trace_method
from crow.schemas.enums import PrimitiveType, SandboxType
from crow.schemas.environment_variables import (
    SandboxEnvironmentVariable as PydanticEnvVar,
    SandboxEnvironmentVariableCreate,
    SandboxEnvironmentVariableUpdate,
)
from crow.schemas.sandbox_config import (
    LocalSandboxConfig,
    ...
    def get_or_create_default_sandbox_config(self, sandbox_type: SandboxType, actor: PydanticUser) -> PydanticSandboxConfig:
        ...
        if not sandbox_config:
            ...
            if sandbox_type == SandboxType.E2B:
                ...
                default_local_sandbox_path = CROW_TOOL_EXECUTION_DIR
