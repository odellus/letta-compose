...
from crow.constants import PINECONE_TEXT_FIELD_NAME
from crow.functions.types import FileOpenRequest
from crow.helpers.pinecone_utils import search_pinecone_index, should_use_pinecone
...
class CrowFileToolExecutor(ToolExecutor):
    """Executor for Crow file tools with direct implementation of functions."""
