...
from crow.constants import MODAL_DEFAULT_TOOL_NAME
...
from crow.services.helpers.tool_parser_helper import parse_function_arguments, parse_stdout_best_effort
...
class AsyncToolSandboxModal(AsyncToolSandboxBase):
    ...
    async def _wait_for_modal_function_deployment(self, timeout: int = 60):
        ...
        from crow.helpers.tool_helpers import generate_modal_function_name
    ...
    async def run(
        ...
        try:
            ...
            if additional_env_vars is None:
                ...
                crow_api_key = additional_env_vars.get("CROW_SECRET_API_KEY", None)
