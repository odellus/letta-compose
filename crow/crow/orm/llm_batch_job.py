...
from crow.orm.custom_columns import CreateBatchResponseColumn, PollBatchResponseColumn
from crow.orm.mixins import OrganizationMixin
from crow.orm.sqlalchemy_base import SqlalchemyBase
from crow.schemas.enums import JobStatus, ProviderType
from crow.schemas.llm_batch_job import LLMBatchJob as PydanticLLMBatchJob
...
class LLMBatchJob(SqlalchemyBase, OrganizationMixin):
    ...
    crow_batch_job_id: Mapped[str] = mapped_column(
        String, ForeignKey("jobs.id", ondelete="CASCADE"), nullable=False, doc="ID of the Crow batch job"
    )
