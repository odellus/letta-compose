...
from crow.orm.custom_columns import CompactionSettingsColumn, EmbeddingConfigColumn, LLMConfigColumn, ResponseFormatColumn, ToolRulesColumn
from crow.orm.identity import Identity
from crow.orm.mixins import OrganizationMixin, ProjectMixin, TemplateEntityMixin, TemplateMixin
from crow.orm.organization import Organization
from crow.orm.sqlalchemy_base import SqlalchemyBase
from crow.schemas.agent import AgentState as PydanticAgentState
from crow.schemas.embedding_config import EmbeddingConfig
from crow.schemas.enums import AgentType
from crow.schemas.environment_variables import AgentEnvironmentVariable as PydanticAgentEnvVar
...
from crow.utils import calculate_file_defaults_based_on_context_window
...
class Agent(SqlalchemyBase, OrganizationMixin, ProjectMixin, TemplateEntityMixin, TemplateMixin, AsyncAttrs):
    ...
    kv_cache_friendly: Mapped[Optional[bool]] = mapped_column(
        Boolean, doc="If set to True, the system prompt will remain immutable between compactions to preserve KV cache for local LLMs."
    )
    ...
    def to_pydantic(self, include_relationships: Optional[Set[str]] = None) -> PydanticAgentState:
        ...
        state = {
            ...
            "kv_cache_friendly": self.kv_cache_friendly,
