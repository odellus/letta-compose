...
from crow.interface import CLIInterface
from crow.local_llm.constants import ASSISTANT_MESSAGE_CLI_SYMBOL, INNER_THOUGHTS_CLI_SYMBOL
from crow.schemas.message import Message
from crow.schemas.openai.chat_completion_response import ChatCompletionChunkResponse, ChatCompletionResponse
...
class AgentChunkStreamingInterface(ABC):
    """Interfaces handle Crow-related events (observer pattern)
