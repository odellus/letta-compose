...
from crow.jobs.helpers import map_anthropic_batch_job_status_to_job_status, map_anthropic_individual_batch_item_status_to_job_status
from crow.jobs.types import BatchPollingResult, ItemUpdateInfo
from crow.log import get_logger
from crow.otel.tracing import trace_method
from crow.schemas.enums import JobStatus, ProviderType
from crow.schemas.crow_response import CrowBatchResponse
from crow.schemas.llm_batch_job import LLMBatchJob
...
@trace_method
async def poll_running_llm_batches(server: "SyncServer") -> List[CrowBatchResponse]:
    """
        ...
        if item_updates:
            ...
            async def _resume(batch_row: LLMBatchJob) -> CrowBatchResponse:
                ...
                return await runner.resume_step_after_request(
                    crow_batch_id=batch_row.crow_batch_job_id,
