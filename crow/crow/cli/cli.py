...
from crow.streaming_interface import StreamingRefreshCLIInterface as interface  # for printing to terminal
...
def server(
    ...
    """Launch a Crow server process"""
    if type == ServerChoice.rest_api:
        pass

        try:
            from crow.server.rest_api.app import start_server
